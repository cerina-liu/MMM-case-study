...
This project demonstrates how marketing data can be translated into actionable business insights using a Marketing Mix Modeling (MMM) framework.

The goal is not only to measure performance, but to support real-world decision making, including budget allocation and investment strategy.
...
- Which channels are actually driving performance?
...
<img width="704" height="388" alt="channel contribution" src="https://github.com/user-attachments/assets/0a756151-bef8-48f2-b6f9-aca12b9ef4f7" />
